...
const MOCK_ACCOUNTS: MatrixAccount[] = [
  {
    ...
    nickname: '花西子官方旗舰店',
    avatar_url: 'https://images.unsplash.com/photo-1542452255191-c85a98f2c5d1?auto=format&fit=crop&q=80&w=200&h=200',
    group: 'OWN_MAIN',
  ...
  },
  {
    ...
    handle: 'comp_beauty',
    nickname: '完美日记官方旗舰店',
    avatar_url: 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?auto=format&fit=crop&q=80&w=200&h=200',
    group: 'COMPETITOR',
